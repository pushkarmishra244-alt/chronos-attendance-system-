...
Charles Babbage,charles.b@attendance.co,student,Computer Science,studentPassword`;
  ...
  return (
    <div className="space-y-6">
      ...
      {/* USER ADMIN MODAL */}
      {showUserModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-xs px-4 animate-fade-in">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl max-w-md w-full p-6 shadow-xl relative animate-scale-up text-xs">
